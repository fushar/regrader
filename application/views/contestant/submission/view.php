	...
	<div class="row">
		<div class="col-md-12">
			<ul class="breadcrumb">
				...
				<li><i class="icon-list-alt"></i> <?php echo $this->lang->line('submission') . ' ' . $submission['id']; ?></li>
		...
		<div class="col-md-12">
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr><td><i class="icon-time"></i> <?php echo $this->lang->line('time'); ?></td><td><?php echo $submission['submit_time']; ?></td></tr>
...
<?php echo htmlspecialchars($submission['compile_result']); ?></pre>
			...
			<form>
				<div class="form-actions">
					<a class="btn" href="<?php echo site_url('contestant/submission/viewAll/' . $page_offset); ?>"><?php echo $this->lang->line('back'); ?></a>
				</div>
			</form>
		</div>
	</div>
