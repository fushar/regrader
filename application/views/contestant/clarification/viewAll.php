					...
					<div class= "modal-content">
						...
						<div class="modal-body">
							<div class="form-group<?php echo form_error('form[title]') == '' ? '' : ' error'; ?>">
								...
								<div class="controls">
									<input name="form[title]" type="text" class="col-md-4form-control" maxlength="255" value="<?php echo set_value('form[title]'); ?>"/>
						...
						<div class="modal-footer">
							<button type="submit" class="btn btn-danger"><i class="glyphicon glyphicon-plus glyphicon-white"></i> <?php echo $this->lang->line('ask'); ?></button>
							<a href="#" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></a>
						</div>
					</div>
				</div>
