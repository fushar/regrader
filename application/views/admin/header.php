			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav navbar-nav">
						...
						<?php if ($page == 'user') : ?><li class="active"><a href="<?php echo site_url('admin/user'); ?>"><i class="glyphiconglyphicon-user glyphicon-white"></i> <?php echo $this->lang->line('users'); ?></a></li><?php endif; ?>
