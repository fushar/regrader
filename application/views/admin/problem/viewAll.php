	...
	<div class="row">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li><i class="icon-list-alt"></i> <?php echo $this->lang->line('problem_list'); ?></li>
				<li><span class="divider">|</span></li>
				<li><i class="icon-plus"></i> <a href="<?php echo site_url('admin/problem/edit/0/' . $page_offset); ?>"><?php echo $this->lang->line('add_new_problem'); ?></a></li>
			</ul>
		</div>
	</div>
			...
			<table class="table table-bordered table-striped">
				<thead>
					<tr>
						...
						<th><i class="icon-user icon-white"></i> <?php echo $this->lang->line('author'); ?></th>
						<th class="problem-limits-th"><i class="icon-file icon-white"></i> <?php echo $this->lang->line('testcases'); ?></th>
						<th class="problem-limits-th"><i class="icon-calendar icon-white"></i> <?php echo $this->lang->line('time_limit'); ?></th>
						<th class="problem-limits-th"><i class="icon-download-alt icon-white"></i> <?php echo $this->lang->line('memory_limit'); ?></th>
