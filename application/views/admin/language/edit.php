	...
	<div class="row">
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group<?php echo form_error('form[extension]') == '' ? '' : ' error'; ?>">
				...
				<div class="form-group<?php echo form_error('form[source_name]') == '' ? '' : ' error'; ?>">
				...
				<div class="form-group<?php echo form_error('form[exe_name]') == '' ? '' : ' error'; ?>">
				...
				<div class="form-group<?php echo form_error('form[compile_cmd]') == '' ? '' : ' error'; ?>">
				...
				<div class="form-group<?php echo form_error('form[run_cmd]') == '' ? '' : ' error'; ?>">
				...
				<div class="form-group<?php echo form_error('form[forbidden_keywords]') == '' ? '' : ' error'; ?>">
				...
				<div class="form-actions">
					<button type="submit" class="btn btn-danger"><?php echo isset($language) ? '<i class="glyphicon glyphicon-download-alt glyphicon-white"></i> ' . $this->lang->line('save') : '<i class="icon-plus icon-white"></i> ' . $this->lang->line('add'); ?></button>
