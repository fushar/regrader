...
class Problem extends Admin_Controller 
{
	...
	/**
	 * Download the input of a testcase
	 *
	 * This function download the input of the testcase whose ID is $testcase_id.
	 * 
	 * @param int $testcase_id The testcase ID.
	 */
	...
	/**
	 * Download the output of a testcase
	 *
	 * This function download the output of the testcase whose ID is $testcase_id.
	 * 
	 * @param int $testcase_id The testcase ID.
	 */
